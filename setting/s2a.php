 ...
 *
 * @version $Id: s2a.php,v 1.2 2007/05/10 16:41:46 leelight Exp $
 * @copyright (C) 2006-2007  leelight
...
<?php
            $tablesobjects = $database->getTableName($dbname);
            showtab($database, $tablesobjects, $dbname, $tbname);
...
<?php
            ...
            showtabd($database, $result, $dbname, $tbname);
...
function showtabd($database, $tablesobjects, $dbname, $tbname)
{
    echo "
		<TR class=\"title\">
		<TD><p id=\"intro\">Table ID</p></TD>
