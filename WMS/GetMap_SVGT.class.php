...
if ($errornumber == 0) {
    ...
    if ($width == "" OR $height == "") {
        $erroroccured = false;
        $errornumber = 13;
        $errorexceptionstring = "The width OR the height cannot be empty. The default is HEIGHT 240 and WIDTH 320 " ;
        $sendexceptionclass->sendexception($errornumber, $errorexceptionstring);
    }
    ...
    for ($ii = 0; $ii < $numberofvalueslayer; $ii++) {
        ...
        */
        ...
        if ($showlayer) {
            ...
            if (!enableStreamSVG) {
                $g[$ii] = &new SvgGroup($layersvalues[$ii], "", "", "");
                $svg->addChild($g[$ii]);
            } else {
                ...
                switch ($data_Geom_Type) {
                            ...
                            switch ($wktparser->wktGeomType) {
                                case "POINT": {
                                        if (!enableStreamSVG) {
                                            ...
                                            $svgpoint[$flagPoint] = new SvgPoint($data_Recid, $data_x[0], - $data_y[0], $xmlSize, $xmlWellKnownName, $style4eachlayer, "");
                                ...
                                case "MULTIPOINT": {
                                        if (!enableStreamSVG) {
                                            ...
                                            $svgz->SvgMultiPoint($data_Recid, $data_x, - $data_y, $xmlSize, $MLine_Point, $style4eachlayer, "", $xmlWellKnownName);
                                        }
                                    }
                            }
                        }
                            ...
                            switch ($wktparser->wktGeomType) {
                                case "POINT": {
                                        ...
                                        if (!enableStreamSVG) {
                                            ...
                                            $svgtext[$flagText] = new SvgText($data_Recid, $data_x[0], - $data_y[0], $data_TextContent, $style4eachlayer, "");
                                ...
                                case "LINESTRING": {
                                        if (!enableStreamSVG) {
                                            ...
                                            $svgtextpath[$flagText] = new SvgTextPath($data_Recid, $pathD, $data_TextContent, $style4eachlayer, "");
                            ...
                            switch ($wktparser->wktGeomType) {
                                case "LINESTRING": {
                                        ...
                                        if (!enableStreamSVG) {
                                            ...
                                            $svgpath[$flagLinestring] = new SvgPath($data_Recid, trim($pathD), $style4eachlayer, "");
                    ...
                    case 'POLYGON': {
                            ...
                            switch ($wktparser->wktGeomType) {
                                case "POLYGON": {
                                        ...
                                        // }
                                        // $svgpolygon[$flagPolygon] = new SvgPolygon($data_Recid, trim($polygonpoints), $style4eachlayer, "");
                                        ...
                                        if (!enableStreamSVG) {
                                            ...
                                            for($i = 0;$i < $MLine_Point;$i++) {
                                                ...
                                                // $polygonpoints .= $data_x[$i][0] . " " . (-$data_y[$i][0]);
                                                $svgpolygon[$flagPolygon] = new SvgPolygon($data_Recid, trim($polygonpoints), $style4eachlayer, "");
                                                $polygonpoints = "";
                                                $g[$ii]->addChild($svgpolygon[$flagPolygon]);
                                            }
                                ...
                                case "MULTIPOLYGON": {
                                        ...
                                        if (!enableStreamSVG) {
                                            for($i = 0;$i < $MLine_Point;$i++) {
                                                ...
                                                // $polygonpoints .= $data_x[$i][0] . " " . (-$data_y[$i][0]);
                                                $svgpolygon[$flagPolygon] = new SvgPolygon($data_Recid . "_" . $i, trim($polygonpoints), $style4eachlayer, "");
                                                $polygonpoints = "";
                                                $g[$ii]->addChild($svgpolygon[$flagPolygon]);
                                                $flagPolygon++;
                                            }
                    ...
                    case 'IMAGE': {
                            ...
                            if (!enableStreamSVG) {
                                ...
                                $svgimage[$flagImage] = new SvgImage($data_Recid, $data_x[0], - $data_y[0], $data_w, $data_h, $data_ImageLink, $style4eachlayer, "");
...
} // end of if (mysql_select_db("geodb") == True)
if ($enablecache) {
    $cache->caching();
}
exit();
