 ...
 */
// require_once '../WMS/Common1.class.php';
class SVGRender {
    private $minx;
    private $miny;
    private $maxx;
    ...
    public function setSVGRender($minx, $miny, $maxx, $maxy, $width, $height, $enablestretchmap)
    {
        $this->minx = $minx;
        $this->miny = $miny;
        $this->maxx = $maxx;
    ...
    /*
//css style
<style type="text/css" id="suasstyles">
<![CDATA[
.g5y7r9i3X9
{
stroke:#660000;
 ...
 */
class SvgElement {
    public $mElements = ""; // Initialize so warnings aren't issued when not used.
    // private $mStyle;
    // private $mTransform;
    // The constructor.
...
class SvgFragment extends SvgElement {
    ...
    public function printElement()
    {
        print("<svg width=\"$this->mWidth" . "px\" height=\"$this->mHeight" . "px\" ");
        // print("viewBox=\"$this->mMinx $this->mMiny $this->mW $this->mH\" ");
        print("viewBox=\"$this->mMinx ".-$this->mMaxy." $this->mW $this->mH\" ");
        // if ($this->mX != "") {
        // print("x=\"$this->mX\" ");
        // }
        // if ($this->mY != "") {
        ...
        print('style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd" ');
...
class SvgGroup extends SvgElement {
    public function SvgGroup($id = "", $style = "", $transform = "", $class = "")
    {
        // Call the parent class constructor.
        $this->SvgElement();
...
class SvgPoint extends SvgElement {
    ...
    public function printElement()
    {$this->mPointstyle = 'X';$this->mR =100;
