...
<?CreateDemoMenu("DescribeLayer");?>
 ...
 <table class="tableContent">
        ...
        <tr>
          <td width="100%"><h2>DescribeLayer Request</h2>&nbsp;</td>
		</tr>
    ...
    ?>
      ...
      <td>
              ...
              <tr>
                 ...
                 <td align="right">
                 <input type="submit" name="button" value="DescribeLayer" onmouseover="this.className='button1'" onmouseout="this.className='button'" class="button">
                 </td>
              </tr>
        </form>
<?php
