...
<?CreateDemoMenu("Transaction");?>
 ...
 <table class="tableContent">
       ...
       <tr>
          <td width="100%"><h2>Transaction Request</h2>&nbsp;
		  </td>
	   </tr>
...
not finished yet.
          ...
          <tr>
             ...
             <input type="submit" name="Bgetcap" value="Transaction" onmouseover="this.className='button1'" onmouseout="this.className='button'" class="button">
             </td>
          </tr>
			</form>
           </table>
