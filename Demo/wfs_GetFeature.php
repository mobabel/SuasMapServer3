...
<?CreateDemoMenu("GetFeature");?>
 ...
 <table  class="tableContent">
       ...
       <tr>
          <td width="100%"><h2>GetFeature Request</h2>&nbsp;
		 </td>
	   </tr>
        <tr>
          	  <td>
...
if ($database->databaseConnection and $error == "") {
 ...
 for (i=0;i<obj.value.length;i++) {
     ...
     if (strRef.indexOf(tempChar,0)==-1) {
        showErrorMessage("Please input number here!");
        if(obj.type=="text")
            obj.focus();
        return false;
     }
    ...
    ?>
        ...
        <!-- The form for the Get Request starts here -->
			<form name="form" action="../WFS/getmapcap.php" method="get" onSubmit="return chkform()">
              ...
              <tr>
                     <td width="200" id="done">MAXFEATURES</td>
                     <td width="100">
    ...
    ?>
      ...
      <td>
          ...
          <tr>
             ...
             <input type="submit" name="Bgetcap" value="GetFeature" onmouseover="this.className='button1'" onmouseout="this.className='button'" class="button">
             </td>
          </tr>
			</form>
<?php
