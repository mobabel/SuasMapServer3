...
<?CreateDemoMenu("GetGmlObject");?>
 ...
 <table class="tableContent">
       ...
       <tr>
          <td width="100%"><h2>GetGmlObject Request</h2>&nbsp;
		  </td>
	   </tr>
...
not finished yet.
          ...
          <tr>
             ...
             <input type="submit" name="Bgetcap" value="GetGmlObject" onmouseover="this.className='button1'" onmouseout="this.className='button'" class="button">
             </td>
          </tr>
			</form>
           </table>
