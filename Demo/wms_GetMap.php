...
if ($database->databaseConnection and $error == "") {
 ...
 <table class="tableContent">
        <tr>
          <td width="100%"><h2>GetMap Request</h2>&nbsp;</br>Select from the currently loaded SRSs</td>
		</tr>

        <tr>
		<td>
           <table class="tableBlock">
             <form name="Fgetmap" action="wms_GetMap_r.php" method="get" onSubmit="return chkform()" >
